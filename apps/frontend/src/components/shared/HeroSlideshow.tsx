...
// Shared full-viewport slideshow used by the home gallery and coring hero sections.
  ...
  return (
    <section id={sectionId} className="scroll-mt-28">
      <div className="relative min-h-[calc(100vh-73px)] overflow-hidden border-b border-slate-700/70">
        ...
        <div className={overlayGradientClassName} />
        <div className={radialGradientClassName} />
